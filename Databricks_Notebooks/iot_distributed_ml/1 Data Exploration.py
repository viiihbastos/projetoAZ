...
# MAGIC - Once you've run the display command in the cell above, try clicking the "+" button to the right of "Table" and explore chart creation. Try creating a Data Profile. 
...
# MAGIC - If a visualization is worth sharing, try the down arrow next to the title to "add to dashboard". Notebook dashboards can be used to collect and share the various visualiztions you create in your notebook
