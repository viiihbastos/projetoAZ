...
# MAGIC %md The purpose of this notebook is to prepare the data for use in the classifier recommender.  You may find this notebook at https://github.com/databricks-industry-solutions/lr-recommender.
